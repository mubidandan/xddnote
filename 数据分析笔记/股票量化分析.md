...
t1.set_token('4076de4ecfa91a712ce124ce3c1edc8dd09a8f964a6bd5eb06aff65e')
...
# sns.lineplot(x="trade_date", y="close",data=sh) 
# plt.show()
```
...
#成对的比较不同数据集之间的相关性，
#而对角线则会显示该数据集的直方图
sns.pairplot(tech_rets.iloc[:,2:].dropna())
```


```python
returns_fig = sns.PairGrid(tech_rets.iloc[:,2:].dropna())
###右上角画散点图
